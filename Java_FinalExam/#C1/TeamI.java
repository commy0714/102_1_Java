...
class TeamI
{
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);//編譯錯誤
		...
		String[][] all{
			{"AA",1,chi,eng,math,total},//編譯錯誤
			{"BB",2,chi,eng,math,total},//編譯錯誤
			{"CC",3,chi,eng,math,total},//編譯錯誤
			{"DD",4,chi,eng,math,total},//編譯錯誤
			{"EE",5,chi,eng,math,total}//編譯錯誤
		};
